...
def gpt_generate_response(chat_history, query, results):
    ...
    response = client.chat.completions.create(
        ...
        messages=chat_history +[
            {"role": "system", "content": "You are a helpful assistant to answer about Credit card terms for banks only in Hong Kong. Use the following results to answer the user's query, and you may search for more relatable context to give the best answer to your user, and if chat history is not related you can define context from query."},
